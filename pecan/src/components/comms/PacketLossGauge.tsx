  ...
  return (
    <div className="flex flex-col gap-1.5">
      ...
      <div className="flex items-center gap-2 px-3 py-1.5 rounded-lg bg-data-textbox-bg border border-sidebarfg/15">
        ...
        <span className="text-sm text-white font-heading ml-auto">
      ...
      <div className="flex items-center gap-2 px-3 py-1.5 rounded-lg bg-data-textbox-bg border border-sidebarfg/15">
        ...
        <span className={`text-sm font-heading ml-auto ${lossColor}`}>
      ...
      {(recovered ?? 0) > 0 && (
        <div className="flex items-center gap-2 px-3 py-1.5 rounded-lg bg-data-textbox-bg border border-sidebarfg/15">
          ...
          <span className="text-sm text-white font-heading ml-auto">{recovered}</span>
        </div>
      )}
    </div>
  );
