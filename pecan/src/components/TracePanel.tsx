    ...
    >
      ...
      >
        ...
        <div className="flex items-center gap-2 text-[10px] font-mono text-slate-500">
          ...
          <span className="ml-1">{visible.length.toString().padStart(2, "0")} rows</span>
          <button
        ...
        {visible.length === 0 ? (
          ...
          <table className="w-full border-collapse text-[11px] font-mono">
            <thead className="bg-[#080715] text-slate-500 sticky top-0">
              <tr>
                <th className="px-2 py-1 text-left w-28">Time</th>
                <th className="px-2 py-1 text-left w-24">ID</th>
                <th className="px-2 py-1 text-left w-10">Dir</th>
