...
const Throttle_Mapper: React.FC = () => {
    ...
    const generateMathCode = (): string => {
        return `// FSAE Throttle Map Function
                    ...
                    <div className="lg:col-span-4 space-y-6">
                        ...
                        <div className="bg-white rounded-xl shadow-sm border border-slate-200 p-6">
                            <div className="flex items-center space-x-2 mb-4">
                                ...
                                <h2 className="font-semibold text-lg">Pedal Simulation</h2>
                            </div>
                            ...
                            <div className="space-y-6">
                                ...
                                {/* CAN Display */}
                                <div className="p-4 bg-slate-900 rounded-lg text-green-400 font-mono text-sm space-y-2">
                                    ...
                                    <div className="space-y-1">
                                        <div className="flex items-center justify-between">
                                            <p className="text-xs text-slate-500">
                                                CAN BUS MESSAGE (ID:{" "}
                                                <span className="text-slate-300">{canId}</span>)
                                            </p>
                        ...
                        <div className="bg-white rounded-xl shadow-sm border border-slate-200 p-6">
                            <div className="flex items-center space-x-2 mb-6">
                                ...
                                <h2 className="font-semibold text-lg">Curve Configuration</h2>
                            </div>
                            ...
                            <div className="space-y-6">
                                ...
                                <div>
                                    ...
                                    <div className="flex justify-between mt-1">
                                        <p className="text-xs text-slate-500">Sensor Noise Filter</p>
                                ...
                                <div>
                                    ...
                                    <div className="flex justify-between text-xs font-medium mt-1">
                                        <span className={gamma < 1 ? "text-purple-600" : "text-slate-400"}>
                                            Aggressive
                                        </span>
                                        <span className={gamma === 1 ? "text-purple-600" : "text-slate-400"}>
                                            Linear
